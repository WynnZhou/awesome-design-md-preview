# Dell (1996) Inspired Design System Analysis

Design system details have been moved to: https://getdesign.md/dell-1996/design-md

You can also view previews, dark mode examples, and download options on getdesign.md.

---

> **Local note — awesome-design-md-previews.** Everything above is the upstream README, byte-for-byte. What is actually in this folder:
>
> | file | what it is |
> |---|---|
> | `DESIGN.md` | the upstream design-system doc, also byte-for-byte |
